...
;
;  to assemble:   nasm -fwin32 flagsPC.asm
...
addloop:    add         EAX, EBX; add the EBX value to current value
...
display2:   push        message1
            call        _printf
; display the carry flag set message
...
message1 db "Carry flag Set!", 10, 0
